...
Producores {data-navmenu="PRODUCCION"}
==========================================================================
...
flujos_productor <-  reactive({
  ...
  entregas_material%>%
    ...
    get.material(Campos = c("Presentacion", "Tipo_material"))%>%
        mutate(Presentacion = ifelse(Presentacion == "125G", "4OZ",
                                 ifelse(Presentacion == "12X125G", "12X4OZ", Presentacion)))
    }
...
precios6oz <- entradas_fruta_a%>%
  filter(Clave_producto == "010201", Precio != 0)%>%
